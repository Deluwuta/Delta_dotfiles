...
myKeys = 
    [
      ...
      -- Common actions
        ...
        ("M-d"        , spawn ("rofi -modi combi -show combi -display-combi 'Rufos ~>>' -combi-modi run,drun")),
        ("M-b"        , spawn ("flatpak run com.brave.Browser")),
        ("M-f"        , spawn ("nautilus")),
        ("M-p s"      , spawn ("flameshot gui")),

      -- Multimedia keys (am scared)
        ...
        ("<XF86KbdBrightnessUp>"   , spawn "$HOME/.xmonad/scripts/kbdbacklight.sh up"),
        ("<XF86KbdBrightnessDown>" , spawn "$HOME/.xmonad/scripts/kbdbacklight.sh down"),
...
myStartupHook = do
    spawnOnce "picom &"
    spawnOnce "feh --bg-scale $HOME/Imágenes/backgrounds/FgaXLRgX0AckiHa.jpg"
...
main :: IO ()
main = do
    handle <- spawnPipe "/home/delta/.xmonad/scripts/launch.sh"
    ...
    xmonad $ ewmh $ docks $ def {
      ...
      -- hooks, layouts
        ...
        logHook            = dynamicLogWithPP $ filterOutWsPP [scratchpadWorkspaceTag] $ xmobarPP { 
            ...
            ppHidden = xmobarColor "#67ff09" "" . clickable,
